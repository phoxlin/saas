...
<body>
	  <form class="l-form" id="sys_db_recordFormObj" method="post">
       ...
       <li style="width: 370px; text-align: left;">
	        <div class="l-text" style="width: 368px;">
	          <input id="sys_db_record__fk_file_id" name="sys_db_record__fk_file_id" class="easyui-validatebox"  style="width: 364px;" type="text" data-options="required:true,validType:'length[0,50]'" value='<%=hasSys_db_record?sys_db_record.getStringValue("fk_file_id"):""%>'/>
	          <div class="l-text-l"></div>
	          <div class="l-text-r"></div>
	        </div>
	      </li>
