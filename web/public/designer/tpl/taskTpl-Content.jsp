...
<#
	if(task.code != "f_mem" && task.code != "f_mem_maintain" 
		&& task.code != "f_mem_potential" && task.code != "f_store"
 		&& task.code != "f_goods" && task.code != "f_goods_type"
		&& task.code != "f_goods_price_change"  && task.code != "f_store_rec"
		&& task.code != "f_emp_mc"  && task.code != "f_emp_pt" && task.code != "f_emp_ex"
		&& task.code != "f_emp_sm" && task.code != "f_generic_type" 
		&& task.code != "f_active_words"){
#>
	<div class="nav-bar">
		...
		<ul>
			<li>
				...
				<a class="cur">
					<p>
						<i class="fa fa-map-marker"></i><span><#=task.name#></span>
					</p>
				</a>
			</li>
		</ul>
