				...
				<#
					for(var i=0;i<trans.length;i++){
						...
						<div role="tabpanel" class="tab-pane <#=tranClass#>" id="<#=tranHref#>">
								<div class="tab-text">
									<select class="form-control " data-userinfo='<#=tran.to#>' <#if(caReadonly){#> disabled <#}#> style="width:180px;margin-top:10px;">
									...
									<#
										for(var ii=0;ii<tran.assigneeVals.length;ii++){
											...
											var code=op.code;
											var note=op.note;
											var loginName=op.login_name;
											if(code==curUserId){
											#>
		  											<option value="<#=code#>"  selected><#=code#>(<#=loginName#>)</option>
											<#
											}else{
											#>
													<option value="<#=code#>" ><#=code#>(<#=loginName#>)</option>
											<#
											}
											#>
											<#
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-4">
						<div class="checkbox col-md-4" style="padding: 0px;line-height: 40px;">
							<label> <input type="checkbox" id="forward_confirm"    checked="checked"  >我已确认
							</label>
						</div>
