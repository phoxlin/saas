<%@page import="com.jinhua.server.tools.QiniuUtils"%>
...
<%
	...
	if(!"uploadimage_ueditor".equals(action)){
...
<%
	...
	try {
		...
		if (qiniu) {
			...
			obj.put("title", qiniuUrl.substring(qiniuUrl.lastIndexOf("/")+1));
			obj.put("original",qiniuUrl.substring(qiniuUrl.lastIndexOf("/")+1));
			...
			obj.put("url", request.getContextPath() + "/getUploadPic/" + uploadFile.getHashCode());
			obj.put("title", "图片");
			obj.put("original","");
			obj.put("state", "SUCCESS");
		}
