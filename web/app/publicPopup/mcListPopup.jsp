...
<div class="popup popup-public-mcList" >
	<header class="bar bar-nav">
		<a class="icon icon-left pull-left"  onclick="closePopup('.popup-public-mcList');"></a>
		<h1 class="title">会籍</h1>
	</header>
	<div class="bar bar-header-secondary">
		<div class="searchbar">
			<div class="search-input">
				<label class="icon icon-search" for="search"></label> <input type="search" id='mc-public_search' placeholder='搜索' />
			</div>
		</div>
...
<!-- 		</div> -->
	...
	<div class="content" id="mc-public-ListDiv">
	</div>
</div>
<script type="text/javascript">
$('#mc-public_search').on('input propertychange', function() {
     var search = $("#mc-public_search").val();
     if(search != ""){
...
<script type="text/html" id="mc-public-ListTpl"> 
