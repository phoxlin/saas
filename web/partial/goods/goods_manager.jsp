		...
		<div class="menu-left" style="float: left">
			<div>
				...
				<ul class="menu" style="width: 200px">
					...
					<li onclick="window.location.reload()" class="active"><i class="l3"></i>商品管理</li>
					<li onclick="window.location.href='partial/goods/goods_store.jsp'" class=""><i class="l3"></i>仓库管理</li>
...
<script type="text/javascript">
$(function(){
	$("#gt").load("pages/f_goods/index.jsp");
})
</script>
</html>