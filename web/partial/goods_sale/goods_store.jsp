	...
	<div class="page-wrapper">
		...
		<div class="page-main page-main-cashier" style="width: 1200px;">
			<div class="nav-bar">
				...
				<ul>
					...
					<a href="javascript:void(0)" onclick="window.location.href='partial/goods_sale/sales.jsp'" class="manageRent">
					 ...
					 <a href="javascript:void(0)" onclick="window.location.href ='partial/goods_sale/goods_manager.jsp'" class="manageRent">
							<p>
						...
						<a class="cur">
							<p>
								<i class="fa fa-map-marker"></i><span>商品库存</span>
							</p>
						</a>
			...
			<div class="container-tab">
				<ul class="tabs">
					<li id="goods_tab" onclick="showStore(this)" class="active"><a>仓库</a></li>
					<li id="types_tab" onclick="showRecord(this)"><a>出入库记录</a></li>
				</ul>
			</div>
			<div class="container-btn searchbar" id="content" style="display: block; padding-top: 10px; padding-left: 0px; height: 800px; width: 99%; text-align: center; overflow: auto;"></div>
...
<script type="text/javascript">
	function showStore(t) {
		$(t).addClass("active");
		$("#types_tab").removeClass("active");
		$("#content").html();
		$("#content").load("pages/f_store/index.jsp");
	}
	function showRecord(t) {
		$(t).addClass("active");
		$("#goods_tab").removeClass("active");
		$("#content").html();
		$("#content").load("pages/f_store_rec/index.jsp");
	}
</script>
</html>