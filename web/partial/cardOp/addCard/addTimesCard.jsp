	...
	<div class="container">
		<div class="col-xs-6">
			...
			<div class="input-panel">
				<label>名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称</label> <input type="text" id="card_name" /> <span id="helpBlock" class="help-block">如：普通次卡、充值赠送、活动次卡……</span>
			</div>
		</div>
		<div class="col-xs-6">
			<span class="need">*</span>
			<div class="input-panel">
				<label>充值次数</label> <input type="number" id="card_times" value="10"> <span id="helpBlock" class="help-block">例如：365</span>
			</div>
		</div>
		<div class="col-xs-6">
			<span class="need">*</span>
		...
		<div class="col-xs-6">
			<div class="input-panel">
				<label>有效天数</label> <input type="number" id="card_days" value="365"> <span id="helpBlock" class="help-block">例如：365</span>
			</div>
		</div>
		<div class="col-xs-6" >
				<div class="input-panel">
					<label>&nbsp;家庭卡&nbsp;&nbsp;</label>  <select id="is_fanmily">
		...
		<div class="col-xs-6">
			<div class="input-panel">
				<label class="mini">免费请假次数</label> <input type="text" id="card_leave_free_times" value="0" />
			</div>
		</div>
		<div class="col-xs-6">
			<div class="input-panel">
