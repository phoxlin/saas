...
<body>
	  <form class="l-form" id="f_articleFormObj" method="post">
	    ...
	    <input id="f_article__cust_name" name="f_article__cust_name" type="hidden" value='<%=hasF_article?f_article.getStringValue("cust_name"):cust_name%>'/>
	    <input id="f_article__gym" name="f_article__gym" type="hidden" value='<%=hasF_article?f_article.getStringValue("gym"):gym%>'/>
       ...
       <li style="width: 170px; text-align: left;">
	        <div class="l-text" style="width: 168px;">
	          <%=UI.createSelectBySql("f_article__art_type", "select id code,type note from f_generic_type where cust_name = '"+cust_name+"' and gym ='"+gym+"' and table_name = 'f_article' and state='001'", hasF_article?f_article.getStringValue("art_type"):"", true, "{'style':'width:164px'}") %>
	          <div class="l-text-l"></div>
	          <div class="l-text-r"></div>
	        </div>
	      </li>
