...
<script type="text/javascript">
 function showBuyCard(){
		top.dialog({
			url : "pages/f_mem/buyCard/buyCard.jsp?cardType=001",
			title : "购买天数卡",
			width : 1000,
			height : 750,
			okValue : "确定",
...
<body>
  ...
  <script type="text/html" id="mineCardTpl">
	...
	<ul class="nav nav-tabs nav-tabs-custom" role="tablist">
		...
		<li role="presentation"><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab"> <span class="nav-tabs-left"></span> <span class="nav-tabs-text">请假记录</span> <span class="nav-tabs-right"></span>
		</a></li>
	</ul>
	...
	<div class="tab-content" style="height: 400px;">
		<div role="tabpanel" class="tab-pane fade in active" id="tab1">
			<jsp:include page="/pages/f_user_card/index.jsp">
				...
				<jsp:param value="001" name="fk_card_type" />
			</jsp:include>
		</div>
		<div role="tabpanel" class="tab-pane fade in" id="tab2">
			<div role="tabpanel" class="tab-pane fade in active" id="tab1">
				<jsp:include page="/pages/f_leave/index.jsp">
					<jsp:param value="<%=fk_user_id%>" name="fk_user_id" />
				</jsp:include>
			</div>
		</div>
