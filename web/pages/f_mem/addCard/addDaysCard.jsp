...
<body  style="padding:20px">
	...
	<form class="form-horizontal" id="addDaysCardForm">
		<div class="form-group">
			<label class="col-sm-2 control-label">天数卡名称</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="card_name">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">充值天数</label>
			<div class="col-sm-10">
				<input type="number" class="form-control" id="card_days" value="0"> <span id="helpBlock" class="help-block">例如：365</span>
			</div>
		</div>
		<div class="form-group">
