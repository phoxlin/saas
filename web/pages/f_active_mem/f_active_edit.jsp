...
<body>
	<div style="width: 990px;height:700px;overflow: auto">		
	  <form class="l-form" id="f_activeFormObj" method="post">
	    ...
	    <input id="f_active__for_mem" name="f_active__for_mem" type="hidden" value='<%=hasF_active?f_active.getStringValue("for_mem"):"Y"%>'/>
       ...
       <li style="width: 170px; text-align: left;">
	    ...
	    <ul id="cardTypeUl" style="background-color: #f2f3f5;height: 50px;<%if(item_num<=0){ %> display:none <%} %>">
		 	<li>
			    <h3>活动项目 </h3>
		 	</li>
		 	<li style="width: 40px"></li>
