...
public class 本日新增会员 extends BasicAction {
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");

	@Route(value = "/fit-app-action-todayAddNewAddMem", conn = true, m = HttpMethod.POST, type = ContentType.JSON)
	public void todayAddNewAddMem() throws Exception {
		...
		size = en.executeQuery("select a.id,a.mem_name,a.phone,a.create_time,a.imp_level,b.headurl from f_mem_" + cust_name
				+ " a  left join f_wx_cust_" + cust_name
				+ " b on a.wx_open_id = b.wx_open_id where a.gym = '"+gym+"' and state='001' and  TO_DAYS(NOW()) = TO_DAYS(a.CREATE_TIME)    and a.mc_id in ("
