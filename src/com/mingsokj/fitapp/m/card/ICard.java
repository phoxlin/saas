...
public abstract class ICard implements Comparable<ICard> {
	 ...
	 * 自动出入场
	 */
	public abstract void autoCheckin(Action act, User emp, HttpServletRequest request, JSONObject obj) throws Exception;
	...
	public abstract void checkOut(Action act, JSONObject obj) throws Exception;
